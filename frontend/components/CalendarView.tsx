...
const CalendarView: React.FC<CalendarViewProps> = ({ onOpenNewEntry, onStartFocus, onCreateEvent, onEditEvent }) => {
  ...
  const [events, setEvents] = useState<CalendarEvent[]>([
    ...
    { 
        ...
        title: '产品同步会', 
        subtitle: '会议', 
        startTime: 10 * 60, // Overlap test
        duration: 90, 
        color: 'amber', 
        avatars: [
            'https://lh3.googleusercontent.com/aida-public/AB6AXuCmUtswof7-cIj70hPJc2HboEdg2zNnzGCHljdMgewm4TGhJycWW0IAnr3e5gCCnqIpDXQB8xlZOsIKtFIIbtFSbxlisg25Mapp7dPutw0cZfkk_56dz1GlB004xuDTQfaBO4m6zcblyhQKzd4Wrek5mqZ4sKRBy8A9bWbv1YLQ7AT1nISvsZe6KKAIx5wavmgXisUhGan3J9v3W5x1XPtx8TP0Qij5BCMDzXxXv6fwDK75sS1Db25a2g5MlmAS-Z3pn7d7GAaAdGg', 
            'https://lh3.googleusercontent.com/aida-public/AB6AXuDz1NeP1b0jOd8_Mww_wsnBSZ7mlPgTsK7uAe7Y6bRgxM6US_PRlELMO_9gb9hTlG48zlnBWoNhtMlp_fFbOC9b9b46i33pwptoZJIIapqlvKPo49fEvAf6dZIxpukTxBYIOolYILpmeYwnG5_RcgAnBpY3VTpyGnl6xwHTX449YJ6681MxagbAtPtRnJ4lmtsRU68UCNVcWWZSgGSdCPIhCxVYdwQtUMBemSP6s2YsKw1ZhigXAg5CUu9t3kWC646HbYJbpcFp6fI'
        ] 
    },
    { 
        id: '3', 
                ...
                <div className="grid grid-cols-7 gap-y-1">
                    {dates.map((date) => (
                        <div key={date} className="flex items-center justify-center h-10 cursor-pointer" onClick={() => setSelectedDate(date)}>
                            <div className={`flex items-center justify-center size-9 rounded-full text-sm font-medium transition-all ${
                                selectedDate === date 
